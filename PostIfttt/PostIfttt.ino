...
const char* myKey = "cKGBzf83hvn8FnfS8dYYYo"; // your maker key here
const char* ssid = "Backup_CSL";              // your router ssid here
const char* password = "100%backup";          // your router password here
